          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="absolute inset-0 -z-10 -mx-28 rounded-b-[3rem] pointer-events-none overflow-hidden" aria-hidden="true">
              <div className="absolute left-1/2 -translate-x-1/2 bottom-0 -z-10" >
                <Image src={Illustration} className="max-w-none opacity-50" width={2146} priority alt="Hero Illustration" />
              </div>
            </div>
            ...
            <div className="pt-32 pb-16 md:pt-52 md:pb-32">
              ...
              <div className="max-w-4xl mx-auto text-center">
                <div className="absolute inset-0 bottom-[45%] -z-10 flex justify-center items-center" aria-hidden="true" data-aos="fade-down">
                  <Image src={"/images/product/sleeppuds-from-behind.png"} alt="SleepPods" className="max-w-none" width={375} height={375} quality={100} priority />
                </div>
                <h1 className="text-7xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-800/60 pb-4" data-aos="fade-down">SleepPods&trade; </h1>
                <h2 className={"h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4"} data-aos="fade-up">Deepen Your Sleep, Enhance Your Health</h2>
