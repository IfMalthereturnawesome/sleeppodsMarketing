...
import {
  getLocalStorage,
  setLocalStorage,
} from "@/lib/analytics/StorageHelper";
...
export default function CookieBanner() {
  ...
  return (
    <>
      ...
      >
        <div className="text-white pl-5 pr-3 py-5 lg:mt-0 flex flex-col lg:items-start font-sans">
          <p className={"text-lg inline font-extrabold"}>
            SleepPods.io doesn&apos;t use third-party cookies
          </p>
